...
const EditFoodItems = (props) => {
    ...
    return (<div className="container">
        ...
        <div className="inputWrapper">
            <input type="text" className="inputField" placeholder="Enter food name"
                value={name} onChange={(e) => setName(e.target.value)}
            />
            {error && !name && <span className="input-error">Please enter valid name</span>}
        </div>
        <div className="inputWrapper">
            <input type="text" className="inputField" placeholder="Enter price"
        ...
        <div className="inputWrapper">
            <input type="text" className="inputField" placeholder="Enter image path"
        ...
        <div className="inputWrapper">
            <input type="text" className="inputField" placeholder="Enter description"
